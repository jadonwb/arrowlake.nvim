...
local M = {
  ...
  bg_hover = selection,
  bg_search = selection,
  bg_search_current = Util.blend_bg(focus, 0.45, bg),
  ...
  functions = primary,
  functions_builtin = Util.blend_bg(primary, 0.85, bg),
  constructor = magenta,
  operator = operator,
  punctuation = fg_dark,
  markup = magenta,
  ...
  error = red, --same
  warning = yellow, --same
  info = green, -- TODO: make part of lsp table
  hint = cyan, -- same
  success = green, -- same
  todo = green, -- make part of todo/comment table
