...
@theme inline {
  ...
  --color-arrowlake-${_style}-bg-active-parameter: oklch(from ${bg_active_parameter} l c h);
  --color-arrowlake-${_style}-bg-dark: oklch(from ${bg_dark} l c h);
  --color-arrowlake-${_style}-bg-darker: oklch(from ${bg_darker} l c h);
  --color-arrowlake-${_style}-bg-float: oklch(from ${bg_float} l c h);
  --color-arrowlake-${_style}-bg-highlight: oklch(from ${bg_highlight} l c h);
  --color-arrowlake-${_style}-bg-hover: oklch(from ${bg_hover} l c h);
  --color-arrowlake-${_style}-bg-menu-sel: oklch(from ${bg_highlight} l c h);
  --color-arrowlake-${_style}-bg-search: oklch(from ${bg_search} l c h);
  --color-arrowlake-${_style}-bg-search-current: oklch(from ${bg_search_current} l c h);
  --color-arrowlake-${_style}-bg-sidebar: oklch(from ${bg_sidebar} l c h);
  --color-arrowlake-${_style}-bg-status: oklch(from ${status.bg} l c h);
  --color-arrowlake-${_style}-bg-visual: oklch(from ${bg_visual} l c h);
  --color-arrowlake-${_style}-ai: oklch(from ${ai} l c h);
  --color-arrowlake-${_style}-black: oklch(from ${black} l c h);
  ...
  --color-arrowlake-${_style}-regexp: oklch(from ${operator} l c h);
  --color-arrowlake-${_style}-border: oklch(from ${border} l c h);
  --color-arrowlake-${_style}-border-highlight: oklch(from ${border_color} l c h);
  --color-arrowlake-${_style}-comment: oklch(from ${comment} l c h);
  ...
  --color-arrowlake-${_style}-directory: oklch(from ${title} l c h);
  ...
  --color-arrowlake-${_style}-error: oklch(from ${error} l c h);
  ...
  --color-arrowlake-${_style}-fg-sidebar: oklch(from ${fg_sidebar} l c h);
  ...
  --color-arrowlake-${_style}-hint: oklch(from ${hint} l c h);
  --color-arrowlake-${_style}-info: oklch(from ${info} l c h);
  --color-arrowlake-${_style}-attention: oklch(from ${attention} l c h);
  --color-arrowlake-${_style}-link: oklch(from ${link} l c h);
  ...
  --color-arrowlake-${_style}-operator: oklch(from ${operator} l c h);
  ...
  --color-arrowlake-${_style}-success: oklch(from ${success} l c h);
  --color-arrowlake-${_style}-cyan: oklch(from ${cyan} l c h);
  --color-arrowlake-${_style}-list: oklch(from ${operator} l c h);
  --color-arrowlake-${_style}-todo: oklch(from ${todo} l c h);
  --color-arrowlake-${_style}-title: oklch(from ${title} l c h);
  --color-arrowlake-${_style}-trace: oklch(from ${trace} l c h);
  --color-arrowlake-${_style}-warning: oklch(from ${warning} l c h);
