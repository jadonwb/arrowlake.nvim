...
function M.generate(colors)
  local zathura = util.template(
    [[
# Arrowlake color theme for Zathura
# Swaps Foreground for Background to get a light version if the user prefers
#
# Arrowlake color theme
#
set notification-error-bg "${diagnostics.error}"
set notification-error-fg "${fg}"
set notification-warning-bg "${diagnostics.warning}"
set notification-warning-fg "${terminal.black}"
...
set completion-highlight-bg "${terminal.black}"
set completion-highlight-fg "${fg}"
set index-bg "${bg}"
set index-fg "${fg}"
set index-active-bg "${terminal.black}"
