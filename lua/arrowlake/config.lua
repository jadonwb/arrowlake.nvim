...
M.defaults = {
  ...
  ---@param highlights arrowlake.Highlights
  ---@param colors ColorScheme
  ...
  plugins = {
    ...
    --   * https://github.com/jadonwb/arrowlake.nvim/tree/main/lua/arrowlake/groups
    -- telescope = true,
  },
}

---@type arrowlake.Config
M.options = nil

---@param options? arrowlake.Config
